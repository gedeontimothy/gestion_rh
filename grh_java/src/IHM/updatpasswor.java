 ...
 * @author New User
 */
public class updatpasswor extends javax.swing.JFrame {

    /**
     * Creates new form updatpasswor
     */
    public updatpasswor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ANCIEN PASSWORD");
...
//      db.ConnexionIntoDataBase();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updatpasswor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updatpasswor().setVisible(true);
